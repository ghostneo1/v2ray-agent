...
- [Cloudflare 优化方案](https://github.com/ghostneo1/v2ray-agent/blob/main/documents/optimize_V2Ray.md)
- [流量中转](https://github.com/ghostneo1/v2ray-agent/blob/main/documents/traffic_relay.md)
- [手动自建教程](https://github.com/ghostneo1/v2ray-agent/blob/main/documents/Cloudflare_install_manual.md)
...
- [Cloudflare入门教程](https://github.com/ghostneo1/v2ray-agent/blob/main/documents/cloudflare_init.md)
...
- 支持任意组合安装、支持多用户管理、支持DNS流媒体解锁、支持添加多端口、[支持任意门解锁Netflix](https://github.com/ghostneo1/v2ray-agent/blob/main/documents/netflix/dokodemo-unblock_netflix.md)
- 支持卸载后保留tls证书
- 支持IPv6，[IPv6注意事项](https://github.com/ghostneo1/v2ray-agent/blob/main/documents/ipv6_help.md)
- 支持WARP分流、IPv6分流
- 支持BT下载管理、日志管理、域名黑名单管理、核心管理、伪装站点管理
- [支持自定义证书安装](https://github.com/ghostneo1/v2ray-agent/blob/main/documents/install_tls.md)
...
- [联通日本软银](https://github.com/ghostneo1/v2ray-agent/blob/main/documents/donation_aff.md#4%E8%81%94%E9%80%9A-%E6%97%A5%E6%9C%AC%E8%BD%AF%E9%93%B6)
- 联通+台湾TFN
- 联通+NTT
- 广移/珠移+HKIX/CMI/NTT
...
- **如用CDN又同时使用直连，关闭云朵+自选IP，自选IP参考上方的[Cloudflare 优化方案](https://github.com/ghostneo1/v2ray-agent/blob/main/documents/optimize_V2Ray.md)**
- **使用纯净系统安装，如使用其他脚本安装过并且自己无法修改错误，请重新安装系统后再次尝试安装**
- wget: command not found [**这里需要自己手动安装下wget**]
  ，如未使用过Linux，[点击查看](https://github.com/ghostneo1/v2ray-agent/tree/master/documents/install_tools.md)安装教程
- 不支持非root账户
...
- **[如有使用不明白的地方请先查看脚本使用指南](https://github.com/ghostneo1/v2ray-agent/blob/main/documents/how_to_use.md)**
...
- **低版本脚本升级高版本时无法启动问题，[请点击此链接查看解决方案](https://github.com/ghostneo1/v2ray-agent/blob/main/documents/how_to_use.md#4%E4%BD%8E%E7%89%88%E6%9C%AC%E5%8D%87%E7%BA%A7%E9%AB%98%E7%89%88%E6%9C%AC%E5%90%8E%E6%97%A0%E6%B3%95%E5%90%AF%E5%8A%A8%E6%A0%B8%E5%BF%83)**

## [脚本使用指南](https://github.com/ghostneo1/v2ray-agent/blob/main/documents/how_to_use.md)、[脚本目录](https://github.com/ghostneo1/v2ray-agent/blob/main/documents/how_to_use.md#5脚本目录)
...
[您可以使用我的AFF进行购买VPS捐赠-Github](https://github.com/ghostneo1/v2ray-agent/blob/main/documents/donation_aff.md)

[支持通过虚拟币向我捐赠](https://github.com/ghostneo1/v2ray-agent/blob/main/documents/donation.md)
...
```
wget -P /root -N --no-check-certificate "https://raw.githubusercontent.com/ghostneo1/v2ray-agent/main/install.sh" && chmod 700 /root/install.sh && /root/install.sh
```
