...
acmeInstallSSL() {
	if [[ "${dnsSSLStatus}" == "true" ]]; then
		...
		if [[ -n "${txtValue}" ]]; then
			...
			echoContent yellow " ---> 添加方法请参考此教程，https://github.com/ghostneo1/v2ray-agent/blob/main/documents/dns_txt.md"
...
dokodemoDoorUnblockStreamingMedia() {
	...
	echoContent red "\n=============================================================="
	echoContent yellow "# 注意事项"
	echoContent yellow "任意门解锁详解，请查看此文章[https://github.com/ghostneo1/v2ray-agent/blob/main/documents/netflix/dokodemo-unblock_netflix.md]\n"
...
menu() {
	...
	echoContent red "\n=============================================================="
	echoContent red "                        推广区                      "
	echoContent green "AFF捐赠：https://github.com/ghostneo1/v2ray-agent/blob/main/documents/donation_aff.md\n"
